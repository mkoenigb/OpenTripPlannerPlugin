...
class OpenTripPlannerPlugin():
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg.AggregatedIsochrones_RequestIsochrones.clicked.connect(lambda: self.aggregated_isochronesStartWorker()) #Call the start worker method
            self.dlg.AggregatedIsochrones_Cancel.clicked.connect(lambda: self.aggregated_isochronesKillWorker())
            ...
            self.dlg.AggregatedIsochrones_SelectInputLayer.currentIndexChanged.connect(self.gf.aggregated_isochrones_maplayerselection)
        ...
        self.dlg.AggregatedIsochrones_FromDateTime.setDateTime(QtCore.QDateTime.currentDateTime())
        self.dlg.AggregatedIsochrones_ToDateTime.setDateTime(QtCore.QDateTime.currentDateTime())
